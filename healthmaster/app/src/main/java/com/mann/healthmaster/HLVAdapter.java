...
public class HLVAdapter extends RecyclerView.Adapter<HLVAdapter.ViewHolder> {
    ...
    ArrayList<Player> mydata;
    Context context;

    public HLVAdapter(Context context, ArrayList<Player> data) {
        super();
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        viewHolder.tvSpecies.setText(mydata.get(i).Name);
        viewHolder.imgThumbnail.setImageBitmap(imageLoader.imageLoad(context, mydata.get(i).Image));
